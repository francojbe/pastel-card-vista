  ...
  return <div className="fixed inset-0 bg-background/80 backdrop-blur-sm z-50 flex items-center justify-center">
      <Card className="w-[350px] overflow-hidden">
        <CardHeader className="bg-gradient-to-r from-[#00C853] to-[#00E676] p-6">
          <h2 className="font-bold text-white text-center text-lg my-0 py-0 px-0 mx-0">Ingresa tu PIN de verificación</h2>
        </CardHeader>
        <CardContent className="p-6 space-y-8 bg-green-100 my-0">
          <form onSubmit={handleSubmit} className="space-y-8 py-0 px-0">
            <div className="rounded-lg p-4">
              <Input ref={inputRef} type="password" value={value} onChange={handleInputChange} className="tracking-[1em] text-center text-xl bg-transparent border-neutral-700 
                          focus:border-green-500 text-green-400 h-12" maxLength={8} autoComplete="off" placeholder="········" />
            </div>
